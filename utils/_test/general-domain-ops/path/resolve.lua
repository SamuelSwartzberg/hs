...
assertMessage(source1, env.HOME .. "/path/to/file")
assertMessage(target1, env.HOME .. "/path/to/file")

-- Test 2: Basic input with s.path and t.path
local source2, target2 = resolve({ s = { path = "path/to/file" }, t = { path = "new/path/to/file" } })
assertMessage(source2, env.HOME .. "/path/to/file")
assertMessage(target2, env.HOME .. "/new/path/to/file")
...
assertMessage(source5, "http://" .. env.HOME .. "/path/to/file.html")
assertMessage(target5,env.HOME .. "/path/to/file")
...
assertMessage(source6, "http://" .. env.HOME .. "/path/to/file.html")
assertMessage(target6, "https://" .. env.HOME .. "/new/path/to/file.txt")
...
assertMessage(source8, env.HOME .. "/path/to/file")
assertMessage(target8, env.HOME .. "/path/to/file")

-- Test 9: Basic input with s.path and t.path as strings
local source9, target9 = resolve({ s = "path/to/file", t = "new/path/to/file" })
assertMessage(source9, env.HOME .. "/path/to/file")
assertMessage(target9, env.HOME .. "/new/path/to/file")
...
assertMessage(source11, "http://" .. env.HOME .. "/path/to/file.html")
assertMessage(target11, "https://" .. env.HOME .. "/path/to/file.txt")
...
assertMessage(source14, "http://" .. env.HOME .. "/path/to/file")
assertMessage(target14, "https://" .. env.HOME .. "/path/to/file")