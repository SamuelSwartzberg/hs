...
local nextRun1 = transf.cronspec_string.next_timestamp_s(cronExpression1)
...
local nextRun2 = transf.cronspec_string.next_timestamp_s(cronExpression2)
...
local nextRun3 = transf.cronspec_string.next_timestamp_s(cronExpression3)
