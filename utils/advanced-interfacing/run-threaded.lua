...
--- @param command_specifier_list { [string|number]: command_parts | string } A table where the key is either a string or a number and the value is a table representing the command parts to be executed. The key is used to identify the command in the results table.
