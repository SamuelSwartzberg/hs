ArrayOfNonArrayInterfacesSpecifier = {
  ...
  properties = {
    getables = {
      ["is-array-of-string-items"] = bind(isArrayOfInterfacesOfType, {a_use, "string-item" }),
      ["is-array-of-audiodevices"] = bind(isArrayOfInterfacesOfType, {a_use, "audiodevice-item" }),
