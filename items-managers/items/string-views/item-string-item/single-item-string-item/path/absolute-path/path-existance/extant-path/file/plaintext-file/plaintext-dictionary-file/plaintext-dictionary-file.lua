  ...
  properties = {
    getables = {
      ["is-yaml-file"] = function(self)
        return getStandartizedExtension(self:get("contents")) == "yaml"
      end,
      ["is-json-file"] = function(self)
        return getStandartizedExtension(self:get("contents")) == "json"
      end,
      ["is-bib-file"] = function(self)
        return getStandartizedExtension(self:get("contents")) == "bib"
      end,
      ["is-toml-file"] = function(self)
        return getStandartizedExtension(self:get("contents")) == "toml" 
      end,
      ["is-ini-file"] = function(self)
        return getStandartizedExtension(self:get("contents")) == "ini"
      end,
      ["is-ics-file"] = function(self)
        return getStandartizedExtension(self:get("contents")) == "ics"
      end,
